...
fn main() {
    loop {
        ...
        let practice_number = rand::thread_rng().gen_range(1..=10);
...
fn hm() {
    ...
    user_input.clear();
    io::stdin().read_line(&mut user_input).unwrap();
    let diff3 = checker(correct_answer4, &user_input);
    total_diff += diff4;
    ...
    user_input.clear();
    io::stdin().read_line(&mut user_input).unwrap();
    let diff3 = checker(correct_answer5, &user_input);
    total_diff += diff5;
    ...
    user_input.clear();
    io::stdin().read_line(&mut user_input).unwrap();
    let diff3 = checker(correct_answer6, &user_input);
    total_diff += diff6;
